package sis.project.virtualcash.login;
...
import sis.project.virtualcash.ConnectServer;
...
/*
			for (String credential : DUMMY_CREDENTIALS) {
				...
				if (pieces[0].equals(mEmail)) {
				    ...
				    editor.putString("name",pieces[0]);
				    editor.commit();
...
*/
		    ...
		    String json = "{"+"email:"+et.getText().toString()+";"+"pass:"+et2.getText().toString()+"}";
		    ...
		    try {
				...
				str = in.readLine();
				while (System.currentTimeMillis()-k<10000 && !(str.equals("yes")||str.equals("no"))){
